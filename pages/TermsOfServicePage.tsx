    ...
    return (
        <div className="bg-white py-16">
            <div className="container mx-auto px-6 max-w-4xl prose lg:prose-lg">
                ...
                <p>By providing your mobile number and opting in, you agree to receive text messages from Sophia & Jo retail, Inc. These messages may include marketing communications, cart reminders, and order updates.</p>
                <ul>
                    <li><strong>Purpose:</strong> The purpose of the messages is to provide you with marketing and promotional offers, as well as transactional updates about your orders.</li>
                    <li><strong>Opt-Out:</strong> You can cancel the SMS service at any time. Just text "STOP" to the short code. After you send the SMS message "STOP" to us, we will send you an SMS message to confirm that you have been unsubscribed. After this, you will no longer receive SMS messages from us.</li>
                    <li><strong>Help:</strong> If at any time you forget what keywords are supported, just text "HELP" to the short code. After you send the SMS message "HELP" to us, we will respond with instructions on how to use our service as well as how to unsubscribe.</li>
